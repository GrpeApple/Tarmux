...
# Save configuration
save_config () {
	test "${config['ALWAYS_SAVE']}" == 'true' && cat 1> "${CONFIG_DIR:-/data/data/com.termux/files/home/.config/tarmux}/${CONFIG_FILE:-config}" <<-EOC
									...
									'reset',*|*,'reset')
										...
										case "${REPLY:-n}" in
											'y'|'Y')
												...
												printf "config['ALWAYS_SAVE']='false'" 1> "${CONFIG_DIR:-/data/data/com.termux/files/home/.config/tarmux}/${CONFIG_FILE:-config}" &&
												source "${CONFIG_DIR:-/data/data/com.termux/files/home/.config/tarmux}/${CONFIG_FILE:-config}" &&
												printf '' 1> "${CONFIG_DIR:-/data/data/com.termux/files/home/.config/tarmux}/${CONFIG_FILE:-config}" &&
												colors 'BGREEN' 'Done!'
												;;
